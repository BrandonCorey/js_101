...
// What is a substring?
// What does case senetively mean?
// Can we assume all inputs will be strings?

/* EXANPLES AND TEST CASES
...
function substrings(str) {
  ...
  while (startingIndex <= str.length - 2) {
    let idx = 2;
    while (idx <= str.length - startingIndex) {
      let substring = str.slice(startingIndex, startingIndex + idx);
