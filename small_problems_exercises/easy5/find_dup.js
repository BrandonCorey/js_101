...
function findDup(array) {
  ...
  for (let number of array) {
    ...
    frequency[number] += 1;
    if (frequency[number] === 2) return number;
  }
...
console.log(findDup([0,1,2]));
// Function takes array arg
// Create empty object
// Use forEch on array arg
// for each element, check a freq property in empty obj
// If not, set it equal to 0 (use short circuiting)
// Then add 1 to value
